 ...
 *
 */
public class Activiti7InclusiveGatewayTest11 {
    /**
     * 流程部署操作
     */
    @Test
    public void test1(){
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("bpmn/LeaveApplyExclusiveGateWay.bpmn20.xml")
                .name("请假审批测试流程11-网关测试-排他网关")
                .deploy();
    ...
    public  void test2() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceById("ExclusiveGatewayTest:1:3",map);//模拟测试发起一个流程
