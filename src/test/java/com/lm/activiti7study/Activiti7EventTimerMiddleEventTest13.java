...
/**
 * Acriviti7  事件-定时器-中间事件-测试类
 *
 */
public class Activiti7EventTimerMiddleEventTest13 {
    /**
     * 流程部署操作
     */
    @Test
    public void test1(){
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("bpmn/Event-timer-MiddleEventTask.bpmn20.xml")
                .name("测试流程13-事件-定时器-中间事件")
                .deploy();
    ...
    public  void test2() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceById("Event-timer-beginning-MiddleTask:1:3");//模拟测试发起一个流程
    ...
    public void test3(){
        ...
        List<Task> employeeList = taskService.createTaskQuery().taskAssignee("zs").list();//模拟查询当前用户的待办流程
