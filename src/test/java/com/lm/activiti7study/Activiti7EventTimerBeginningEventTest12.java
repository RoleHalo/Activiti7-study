...
/**
 * Acriviti7  事件-定时器-启动事件-测试类
 *
 */
public class Activiti7EventTimerBeginningEventTest12 {
    /**
     * 流程部署操作
     */
    @Test
    public void test1(){
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("bpmn/Event-timer-beginning-serviceTask.bpmn20.xml")
                .name("测试流程12-事件-定时器-启动事件")
                .deploy();
    ...
    public  void test2() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceById("");//模拟测试发起一个流程
